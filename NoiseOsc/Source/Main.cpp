...
//==============================================================================
class NoiseOscApplication  : public juce::JUCEApplication
{
public:
    //==============================================================================
    NoiseOscApplication() {}
    ...
    void initialise (const juce::String& commandLine) override
    {
        ...
        mainWindow.reset(new MainWindow("SimpleSynthNoiseTutorial", new MainComponent(), *this));
    }
...
START_JUCE_APPLICATION (NoiseOscApplication)
